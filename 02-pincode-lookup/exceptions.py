...
class PinCodeNotFoundError(Exception): # Exception is a ready-made parent class for errors in Python.
    def __init__(self, pincode: str): # __init__ runs automatically when you create the error.
